...
irq_stream1_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[1].cbuf[stream[1].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data86_t));
	return 0;
};
int
irq_stream2_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[2].cbuf[stream[2].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data89_t));
	return 0;
};
int
irq_stream3_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[3].cbuf[stream[3].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data92_t));
	return 0;
};
int
irq_stream4_handler(void* data, size_t size) {
	cmd_data92_t cmd_data;
	cmd_data92_rnd(&cmd_data);
	cbuf_add(&stream[4].cbuf[stream[4].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data92_t));
	return 0;
};
int
irq_stream5_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[5].cbuf[stream[5].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data95_t));
	return 0;
};
int
irq_stream6_handler(void* data, size_t size) {
	cmd_data95_t cmd_data;
	cmd_data95_rnd(&cmd_data);
	cbuf_add(&stream[6].cbuf[stream[6].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data95_t));
	return 0;
};
int
irq_stream7_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[7].cbuf[stream[7].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data104_t));
	return 0;
};
int
irq_stream8_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[8].cbuf[stream[8].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data107_t));
	return 0;
};
int
irq_stream9_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[9].cbuf[stream[9].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data110_t));
	return 0;
};
int
irq_stream10_handler(void* data, size_t size) {
	cmd_data107_t cmd_data;
	cmd_data107_rnd(&cmd_data);
	cbuf_add(&stream[10].cbuf[stream[10].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data107_t));
	return 0;
};
int
irq_stream11_handler(void* data, size_t size) {
	cmd_data110_t cmd_data;
	cmd_data110_rnd(&cmd_data);
	cbuf_add(&stream[11].cbuf[stream[11].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data110_t));
	return 0;
};
int
irq_stream12_handler(void* data, size_t size) {
	cmd_data107_t cmd_data;
	cmd_data107_rnd(&cmd_data);
	cbuf_add(&stream[12].cbuf[stream[12].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data107_t));
	return 0;
};
int
irq_stream13_handler(void* data, size_t size) {
	cmd_data110_t cmd_data;
	cmd_data110_rnd(&cmd_data);
	cbuf_add(&stream[13].cbuf[stream[13].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data110_t));
	return 0;
};
int
irq_stream14_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[14].cbuf[stream[14].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data114_t));
	return 0;
};
int
irq_stream15_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[15].cbuf[stream[15].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data117_t));
	return 0;
};
int
irq_stream16_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[16].cbuf[stream[16].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data121_t));
	return 0;
};
int
irq_stream17_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[17].cbuf[stream[17].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data124_t));
	return 0;
};
int
irq_stream18_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[18].cbuf[stream[18].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data132_t));
	return 0;
};
int
irq_stream19_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[19].cbuf[stream[19].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data135_t));
	return 0;
};
int
irq_stream20_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[20].cbuf[stream[20].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data145_t));
	return 0;
};
int
irq_stream21_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[21].cbuf[stream[21].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data154_t));
	return 0;
};
int
irq_stream22_handler(void* data, size_t size) {
	...
	cbuf_add(&stream[22].cbuf[stream[22].irq_cbuf_id], (char*)&cmd_data, sizeof(cmd_data174_t));
	return 0;
};

stream_t stream[STREAM_COUNT_MAX] = {
	{0, "service", 
...
stream_init(void) {
	...
	for(int i=0; i<STREAM_COUNT_MAX; i++) {
		stream[i].url = malloc(STREAM_URL_SIZE_MAX);
		stream[i].cbuf[0].buf = malloc(stream[i].cbuf[0].data_size*STREAM_DATA_SIZE_MAX);
		if(!stream[i].cbuf[0].buf)
			return -1;
		stream[i].cbuf[0].cbuf_size = STREAM_DATA_SIZE_MAX;
		stream[i].cbuf[1].buf = malloc(stream[i].cbuf[1].data_size*STREAM_DATA_SIZE_MAX);
		if(!stream[i].cbuf[1].buf)
			return -1;
		stream[i].cbuf[1].cbuf_size = STREAM_DATA_SIZE_MAX;
	}
	return 0;
}
...
stream_cleanup(void) {
	...
	for(int i=0; i<STREAM_COUNT_MAX; i++) {
		if(stream[i].url)
			free(stream[i].url);
		if(stream[i].cbuf[0].buf)
			free(stream[i].cbuf[0].buf);
		stream[i].cbuf[0].cbuf_size = 0;
		if(stream[i].cbuf[1].buf)
			free(stream[i].cbuf[1].buf);
		stream[i].cbuf[1].cbuf_size = 0;
	}
	return 0;
}
